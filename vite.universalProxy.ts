// vite.universalProxy.ts
// Proxy genérico para DEV: /proxy?target=<BASE>&path=<PATH>&<qs...>
// Exemplos:
//   /proxy?target=https://10.2.1.69/api&path=/v3/login
//   /proxy?target=https://10.2.1.69/api&path=/v3/alarms&pageSize=100000

import type { Plugin } from 'vite';
import { IncomingMessage, ServerResponse } from 'node:http';
import { Agent } from 'undici'; // 👈 importante para aceitar self-signed
